...
vi.mock('@google/ai-cli-core', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@google/ai-cli-core')>();
  return {
    ...actual,
...
describe('mcpCommand', () => {
  ...
  describe('auth subcommand', () => {
    ...
    it('should authenticate with a specific server', async () => {
      ...
      const { MCPOAuthProvider } = await import('@google/ai-cli-core');
